...
@given('I use query OAuth with key="{key}" and secret="{secret}"')
@dereference_step_parameters_and_data
...
@given('I use header OAuth with key="{key}" and secret="{secret}"')
@dereference_step_parameters_and_data
...
@when('I make a HEAD request to "{url_path_segment}"')
@dereference_step_parameters_and_data
...
@when('I make an OPTIONS request to "{url_path_segment}"')
@dereference_step_parameters_and_data
...
@when('I make a TRACE request to "{url_path_segment}"')
@dereference_step_parameters_and_data
...
@when('I make a PATCH request to "{url_path_segment}"')
@dereference_step_parameters_and_data
...
@when('I make a PUT request to "{url_path_segment}"')
@dereference_step_parameters_and_data
...
@when('I store the JSON at path "{jsonpath}" in "{variable}"')
@dereference_step_parameters_and_data
...
@then('the variable "{variable}" should be "{value}"')
@dereference_step_parameters_and_data
...
@dereference_step_parameters_and_data
def json_should_be(context):
    ensure(context.response.json()).contains_some_of(
        json.loads(context.data.decode('utf-8')))


@then('the JSON array length at path "{jsonpath}" should be {value}')
@dereference_step_parameters_and_data
